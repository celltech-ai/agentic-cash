        ...
        <div className="grid gap-8 md:grid-cols-4">
          <div className="md:col-span-1">
            ...
            <p className="mb-4 text-sm text-slate-400">
              AI-powered marketplace arbitrage system. Find profitable deals on autopilot.
            </p>
          ...
          <div>
            <h3 className="mb-3 text-xs font-medium uppercase tracking-wider text-white">Product</h3>
          ...
          <div>
            <h3 className="mb-3 text-xs font-medium uppercase tracking-wider text-white">Resources</h3>
            <ul className="space-y-2 text-sm">
              <li>
          ...
          <div>
            <h3 className="mb-3 text-xs font-medium uppercase tracking-wider text-white">Legal</h3>
            <ul className="space-y-2 text-sm">
              <li>
              ...
              <li>
                <Link href="/affiliate" className="text-slate-400 hover:text-white">
                  Affiliate Program
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-10 border-t border-slate-800 pt-6">
          <div className="flex flex-col items-center justify-between gap-3 md:flex-row">
            <p className="text-xs text-slate-400">
              © {new Date().getFullYear()} Agentic Cash Pipelines. All rights reserved.
            </p>
